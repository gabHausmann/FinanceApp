...
export const MOCK_USER: User = {
  name: 'Gabriel Henrique Hausmann',
  email: 'gabriel.hausmann@email.com',
  plan: 'premium',
};

export const CATEGORIES: Category[] = [
  // Despesas
  { id: 'c1', name: 'Alimentação', icon: 'fast-food', color: '#F59E0B', type: 'expense' },
  { id: 'c2', name: 'Transporte', icon: 'car', color: '#3B82F6', type: 'expense' },
  { id: 'c3', name: 'Moradia', icon: 'home', color: '#8B5CF6', type: 'expense' },
  { id: 'c4', name: 'Saúde', icon: 'medkit', color: '#EF4444', type: 'expense' },
  { id: 'c5', name: 'Lazer', icon: 'game-controller', color: '#EC4899', type: 'expense' },
  { id: 'c6', name: 'Educação', icon: 'school', color: '#06B6D4', type: 'expense' },
  { id: 'c7', name: 'Compras', icon: 'bag-handle', color: '#F97316', type: 'expense' },
  { id: 'c8', name: 'Outros', icon: 'ellipsis-horizontal', color: '#6B7280', type: 'expense' },
  // Receitas
  { id: 'c9', name: 'Salário', icon: 'briefcase', color: '#34D399', type: 'income' },
  { id: 'c10', name: 'Freelance', icon: 'laptop', color: '#34D399', type: 'income' },
  { id: 'c11', name: 'Investimentos', icon: 'trending-up', color: '#34D399', type: 'income' },
  { id: 'c12', name: 'Presente', icon: 'gift', color: '#34D399', type: 'income' },
  { id: 'c13', name: 'Outros', icon: 'add-circle', color: '#34D399', type: 'income' },
];
